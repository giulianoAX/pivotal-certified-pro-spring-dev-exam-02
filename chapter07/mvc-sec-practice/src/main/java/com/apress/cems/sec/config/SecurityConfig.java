 ...
 *  - complete the defintiion of the configure method in order to implement the following:
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/resources/**", "/webapp/WEB-INF/images/**", "/webapp/WEB-INF/styles/**");
    }
